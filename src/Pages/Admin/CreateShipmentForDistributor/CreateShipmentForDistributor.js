...
const CreateShipmentForDistributor = () => {
  ...
  const onFinish = (values) => {
    ...
    setScreen1({
      ...
      distributorName: selectDistrOption,
  ...
  const onDistributorMasterChange = (value) => {
        ...
        >
          ...
          >
            <Space size="large" style={{ width: "100%" }} block>
              <Select
                className="col2"
                onChange={onDistributorMasterChange}
                style={{ width: "100%" }}
                allowClear
              >
                <Option
                  disabled="true"
                  value="------------Select a distributor------------"
                >
                  Please Select
                </Option>
                {distrMaster &&
                  distrMaster.map((ele, idx) => (
                    <>
                      <Option
                        key={idx}
                        value={ele.index + "~" + ele.distributorName}
                      >
                        {ele.index + " " + ele.distributorName}
                      </Option>
                    </>
                  ))}
              </Select>{" "}
...
export default CreateShipmentForDistributor;
